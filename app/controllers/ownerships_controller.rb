  ...
  def create
    ...
    if @item.new_record?
      ...
      begin
        ...
        # response = Amazon::Ecs.item_lookup(asins.join(','),:country => 'jp')
        # response = Amazon::Ecs.item_lookup(asin, :response_group => "ItemAttributes, SalesRank, OfferSummary", :country => 'jp')
